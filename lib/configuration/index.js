...
function sort(taskInfo, rawConfig, parentConfig, optionalSchema) {
	...
	// TODO: when there is `task`, `series` or `parallel` property, then all other properties will be treated as property, not sub-task configs. So user don't have to use `config` keyword or `$` prefix.
