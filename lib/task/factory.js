...
function ConfigurableTaskFactory(stuff, recipeFactory, registry, settings) {
	this.stuff = stuff;
...
ConfigurableTaskFactory.prototype.create = function (prefix, taskInfo, taskConfig, recipe) {
	...
	var configurableTask = function (done) {
		...
		// NOTE: gulp 4.0 task now called with gulp context.
		// see: [bind all functions on the gulp instance to allow destructuring](https://github.com/gulpjs/gulp/commit/73eced0969af4d1e87cea1d7172f90b557b8f7b5)
		// deprecated: gulp 4.0 task are called on undefined context. So we need gulp reference from registry here.
