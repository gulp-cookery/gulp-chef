...
ConfigurableRecipeFactory.prototype.simple = function (taskInfo) {
	return this.inline(taskInfo) || this.reference(taskInfo) || this.plugin(taskInfo) || this.task(taskInfo);
};

ConfigurableRecipeFactory.prototype.composite = function (taskInfo) {
	return this.stream(taskInfo) || this.flow(taskInfo);
};

ConfigurableRecipeFactory.prototype.flow = function (taskInfo) {
	return this.stuff.flows.lookup(taskInfo.name);
};
...
ConfigurableRecipeFactory.prototype.stream = function (taskInfo) {
	return this.stuff.streams.lookup(taskInfo.name);
};
